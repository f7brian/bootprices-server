...
const sendEmail = (to, html, subject) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield transporter.sendMail({
            from: config_1.default.mail, // sender address
        ...
        throw new AppError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, error === null || error === void 0 ? void 0 : error.message);
    }
});
